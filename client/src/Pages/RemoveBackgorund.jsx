...
const RemoveBackgorund = () => {
  return (
    <div className="h-full p-6 flex flex-wrap gap-4 overflow-y-auto items-start text-slate-700">
      <form className="bg-white max-w-lg w-full border border-gray-200 rounded-lg shadow-lg p-4">
        ...
        <input
          type="file"
          accept="image/*"
          className="outline-none border border-gray-200 p-2 px-3 mt-2 rounded-md text-sm w-full"
          required
        />
        <p className="text-xs mt-2 text-gray-400">
          Supports JPG,PNG and other Image formats.
        </p>
        <button className="w-full bg-gradient-to-r from-[#F76C1C] to-[#F04A3C] flex items-center justify-center p-2 px-4 text-white gap-2 text-sm rounded-md mt-8 cursor-pointer">
